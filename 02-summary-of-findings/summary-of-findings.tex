...
\noindent \blueEmph{Update: out of the reported CVEs, four were chosen to be mitigated}

\begin{itemize}
    \item \blueEmph{\texttt{CVE-2016-7406}}
    \item \blueEmph{\texttt{CVE-2018-6683}}
    \item \blueEmph{\texttt{CVE-2021-22927}}
    \item \blueEmph{\texttt{CVE-2022-38652}}
\end{itemize}

\blueEmph{The listed vulnerabilities have \texttt{high} or \texttt{critical} base scores. Also, all of the above greatly impact the integrity of the data, a property crucial for an election. For these reasons, these CVEs were deemed in urgent need of mitigation.}
